...
const AboutUs = () => {
  return (
    <div
      id="about"
      className="py-6 md:py-10 px-4 sm:px-8 md:px-16 border-y-0 w-full max-w-5xl border border-dashed border-gray-300 mx-auto"
    >
      <div className="mx-auto pb-6 md:pb-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-start md:justify-between pt-5 gap-4 md:gap-0">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold w-full md:w-2/3 text-wrap">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 bg-[#e5e5e5] p-1 rounded-lg">
        ...
        <div className="bg-black text-white p-4 sm:p-5 rounded-lg flex flex-col">
          <div className="text-left">
            <h3 className="font-bold text-lg sm:text-xl">Our mission</h3>
          ...
          <div className="mt-auto text-left pt-8 sm:pt-16 flex flex-col gap-3 sm:gap-5">
            <AvatarGroup>
              <Avatar>
                <AvatarImage src="/1.jpeg" alt="Client avatar" />
                <AvatarFallback>CN</AvatarFallback>
              </Avatar>
              <Avatar>
                <AvatarImage src="/2.jpeg" alt="Client avatar" />
                <AvatarFallback>LR</AvatarFallback>
              </Avatar>
              <Avatar>
                <AvatarImage src="/3.jpeg" alt="Client avatar" />
                <AvatarFallback>ER</AvatarFallback>
              </Avatar>
            </AvatarGroup>
            <div>
              <h3 className="font-bold text-lg sm:text-xl">
                Trusted by 155+ businesses
              </h3>
              <p className="text-sm sm:text-base">
                They hit their targets — you are next.
              </p>
            </div>
          </div>
        </div>
