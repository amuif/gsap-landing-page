...
const testimonials = [
    ...
    {
        quote:            'The team distilled our complex offering into a memorable customer journey. The results spoke for themselves.',
        name: 'Avery Johnson',
    ...
    {
        quote:'A seamless experience from concept to launch. Their execution elevated our message and gave us stronger traction.',
        name: 'Owen Brooks',
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-8">
                ...
                <div className="max-w-xl">
                    <p className="text-sm text-left pt-16 text-gray-600">
                        Real stories from brands that use AIthor to scale faster and achieve measurable results.
                    </p>
                </div>
            </div>

            <div className="overflow-hidden rounded-[2rem]  border-none">
                <Marquee className="gap-6 py-8 px-4 md:px-6 border-none" pauseOnHover 
                    style={{
                        WebkitMaskImage:
                        ...
                        >
                                ...
                                <div className='flex items-center gap-1 mb-4 justify-start'>
                                    {Array.from({ length: 5 }).map((_, index) => (
                                        <span key={index} className=" text-lg leading-none ">
                                            <Star stroke='#F04711' className='fill-[#F04711]' size={18} />
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div className=" flex items-center gap-1 p-3">
                                ...
                                <div className="flex flex-col tex-left text-xs">
                                    <span className="font-semibold text-left  text-gray-900">{testimonial.name}</span>
